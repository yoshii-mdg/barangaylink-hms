  ...
  return (
    <section className="w-full py-16 sm:py-20 lg:py-30 bg-gray-50 px-4 sm:px-8 md:px-20 lg:px-40 mt-16 sm:mt-20 lg:mt-30">
      ...
      <div className="mb-10 sm:mb-16">
        ...
        <h1 className="font-bold text-[#005F02] text-3xl sm:text-4xl mb-8 sm:mb-12">
          Get to Know Our Barangay
        </h1>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          <p className="text-base sm:text-[18px] font-semibold leading-relaxed mb-6">
            Our Resident and House Registry System is a digital system created to record and manage
            resident and household information in the community. It helps store important data in an
            organized and easy-to-access way for barangay use.
          </p>

          <p className="text-base sm:text-[18px] font-semibold leading-relaxed mb-8">
            This system focuses on accuracy, proper record-keeping, and ease of use. It supports
            barangay staff in managing resident and house records more efficiently while keeping
            information updated and reliable. Through a simple and structured design, the system
            helps improve daily operations and decision-making.
          </p>

          {/* Bullet Points */}
          <div className="space-y-3">
            {[
              'Organized resident and household records',
              'Easy and secure data management',
              'Simple and user-friendly system',
              'Supports efficient barangay operations',
            ].map((text) => (
